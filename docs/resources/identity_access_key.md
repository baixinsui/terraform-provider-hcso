...
Manages a permanent Access Key resource within Huawei Cloud Stack Online IAM service.

-> **NOTE:** You *must* have admin privileges in your Huawei Cloud Stack Online cloud to use this resource.

...
func TestAccCustomPolicyAttachment_basic(t *testing.T) {
	...
	rName := "hcso_identitycenter_custom_policy_attachment.test"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(rName, "instance_id",
						"data.hcso_identitycenter_instance.system", "id"),
					resource.TestCheckResourceAttrPair(rName, "permission_set_id",
						"hcso_identitycenter_permission_set.test", "id"),
...
resource "hcso_identitycenter_custom_policy_attachment" "test" {
  instance_id       = data.hcso_identitycenter_instance.system.id
  permission_set_id = hcso_identitycenter_permission_set.test.id
